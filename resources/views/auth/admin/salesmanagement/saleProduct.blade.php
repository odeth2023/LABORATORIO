			...
			<div class="col-md-8 DatosProductos p-4">
				...
				<div>
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" placeholder="Producto a buscar" aria-label="Username"
					...
					<div class="col-3">
						...
						<a href="{{route('admin.agregarProductoVenta', $product)}}" class='text-decoration-none'>
							<div class="card h-100">
								<img src="https://www.importadoraespinoza.com/Dinamic/Assets/img/no_image.jpg"
